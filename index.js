...
app.get('/api/hotels', function (req, res) {
  ...
  res.jsonp(_.times(results_count, function () {
    return {
      ...
      images: _.times(_.random(1, 10), function () {
        return faker.image.city(640, 480, true);
      }),
      date_start: ref_date,
...
app.get('/api/reviews', function (req, res) {
  ...
  res.jsonp(_.times(_.random(0, 10), function () {
    return {
